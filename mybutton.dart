...
class MyButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector( // this is a class in flutter used to detect gestures like tap,press,slide etc
      onTap: () { // in this case we have tapped into the flutter button and we will perform the function mentioed in
      ...
      child: Container(
        ...
        color: buttonColor,
        child: Center( // Center is a very useful wifget used when we have to center our items
            child: Text( 
          softWrap: false,
          maxLines: 1,
